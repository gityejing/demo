...
/**
 * Convenience methods for executing non-Java processes. More information about
 * this class is available from <a target="_top" href=
...
public final class ExecHelper {
     ...
     *
     * @param cmdarray array containing the command to call and its arguments.
     * @param charset Output from the executed command is expected to be in this
     * character set.
     * @return The results of the execution in an ExecHelper object.
     * @throws SecurityException if a security manager exists and its checkExec
     * method doesn't allow creation of a subprocess.
     ...
     * No input is passed to the process on STDIN.
     *
     * @param command String containing a command to be parsed by the shell and
     * executed.
     * @return The results of the execution in an ExecHelper object.
     * @throws SecurityException if a security manager exists and its checkExec
     * method doesn't allow creation of a subprocess.
