...
public class Login {
	...
	static String email = "526737403@qq.com";// 你的email
	static String psw = "YEJING881213,";// 你的密码
	// 消息发送的action
	...
	public static void sendMsg() throws Exception {
		...
		poster.addRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");
	...
	public static String StreamOut(InputStream txtis, String code) throws IOException {
