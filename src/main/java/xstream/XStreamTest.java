...
public class XStreamTest {
	...
	public void writeList2XML() {
		try {
			...
			// 将ListBean中的集合设置空元素，即不显示集合元素标签。默认将集合元素作为一个大的父标签显示
	...
	/**
	 * <b>function:</b>用XStream结合JsonHierarchicalStreamDriver驱动 转换java对象为JSON字符串
	 * 
	 * @author hoojo
	 ...
	 * map转换不成功； JsonHierarchicalStreamDriver读取JSON字符串到java对象出错
	 * 
	 * @author hoojo
	...
	public void readJSON2Object() throws JSONException {
		String json = "{\"student\": {" + "\"id\": 1," + "\"name\": \"haha\","
